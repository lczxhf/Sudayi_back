...
database_name = case Padrino.env
  when :development then 'sudayi_back_development'
  when :production  then 'sudayi_back_production'
  when :test        then 'sudayi_back_test'
end
...
#     sessions:
#       default:
#         database: sudayi_back_development
#         hosts:
#           - localhost:27017
#   production:
#     sessions:
#       default:
#         database: sudayi_back_production
#         hosts:
#           - localhost:27017
#   test:
#     sessions:
#       default:
#         database: sudayi_back_test
#         hosts:
#           - localhost:27017
#
#
